...
using Vereyon.Web;
using static RentACars.Helpers.ModalHelper;
    ...
    public class CategoriesController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            return View(await _context.Categories
                .Include(vc => vc.VehicleCategories)
                .ToListAsync());
        }
        [NoDirectAccess]
        ...
        public async Task<IActionResult> AddOrEdit(int id, Category category)
        {
            if (ModelState.IsValid)
            {
                ...
                return Json(new { isValid = true, html = ModalHelper.RenderRazorViewToString(this, "_ViewAllModal", _context.Categories.Include(c => c.VehicleCategories).ToList()) });
